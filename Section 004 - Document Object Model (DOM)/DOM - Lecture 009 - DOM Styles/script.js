...
} //change all list box color to blue

console.log(lis[0].style.cssText = 'background-color: yellow; font-size: 25px;'); //change first box color to yellow and font size to 25px
